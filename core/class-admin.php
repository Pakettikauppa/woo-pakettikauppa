      ...
      ?>
        <div>
          ...
          <?php else : ?>
              ...
              <p>
                  <button type="button" value="create" name="wc_pakettikauppa[create]"
                          class="button pakettikauppa_meta_box" onclick="pakettikauppa_meta_box_submit(this);">
                    <?php echo __('Create', 'woo-pakettikauppa'); ?>
                  </button>
                  <button type="button" value="change" class="button pakettikauppa_meta_box"
                          onclick="pakettikauppa_change_method(this);">
    ...
    public function save_ajax_metabox( $post_id ) {
      ...
      switch ( $command ) {
        case 'create':
          ...
          $shipment_create_pressed = get_post_meta($post_id, '_' . $this->core->prefix . '_create_shipment_pressed', true);

          if ( $shipment_create_pressed !== 'true' ) {
            update_post_meta($post_id, '_' . $this->core->prefix . '_create_shipment_pressed', 'true');
        ...
        case 'delete_shipping_label':
          ...
          update_post_meta($post_id, '_' . $this->core->prefix . '_create_shipment_pressed', 'false');
