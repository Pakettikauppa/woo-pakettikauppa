            ...
            <?php if (!empty($all_shipment_services)) : ?>
              <select name="wc_pakettikauppa_service_id" id="pakettikauppa-service" class="pakettikauppa_metabox_values" onchange="pakettikauppa_change_shipping_method();">
                ...
                <?php foreach ($all_shipment_services as $_service_code => $_service_title) : ?>
                  <option <?php if (strval($_service_code) === $service_id) : ?> selected="selected" <?php endif; ?> value="<?php echo esc_attr($_service_code); ?>">
                ...
                <?php foreach ($_additional_services as $additional_service) : ?>
                  <?php if (empty($additional_service->specifiers) || $additional_service->service_code === '3101') : ?>
                    ...
                    <li class="service-<?php echo $additional_service->service_code; ?>">
                      <input type="checkbox" id="<?php echo $elem_id; ?>" class="pakettikauppa_metabox_array_values" name="wc_pakettikauppa_additional_services" value="<?php echo $additional_service->service_code; ?>" <?php echo ($additional_service->service_code === '3101' && $is_cod || in_array($additional_service->service_code, $default_additional_services) ? 'checked' : ''); ?> />
